...
gwas <- fread("../SURVIVAL_HY3_META1.tbl")
...
# Export it
ggsave("./plots/HY3_manhattan.pdf", thisManhattan, width = 8, height = 4, dpi=300, units = "in")
ggsave("./plots/HY3_manhattan.png", thisManhattan, width = 7, height = 3.5, dpi=300, units = "in")
ggsave("./plots/HY3_manhattan.svg", thisManhattan, width = 7, height = 3.5, dpi=300, units = "in")
